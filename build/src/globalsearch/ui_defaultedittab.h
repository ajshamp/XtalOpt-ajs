...
public:
    ...
    void setupUi(QWidget *DefaultEditTab)
    {
        ...
        gridLayout->addWidget(edit_user1, 7, 1, 1, 2);
        ...
        gridLayout->addWidget(edit_user2, 8, 1, 1, 2);
        ...
        cb_preopt = new QCheckBox(DefaultEditTab);
        cb_preopt->setObjectName(QString::fromUtf8("cb_preopt"));

        gridLayout->addWidget(cb_preopt, 2, 0, 1, 2);

        push_preoptConfig = new QPushButton(DefaultEditTab);
        push_preoptConfig->setObjectName(QString::fromUtf8("push_preoptConfig"));

        gridLayout->addWidget(push_preoptConfig, 2, 2, 1, 1);
    ...
    void retranslateUi(QWidget *DefaultEditTab)
    {
        ...
        cb_preopt->setText(QApplication::translate("DefaultEditTab", "Perform &preoptimization", 0, QApplication::UnicodeUTF8));
        push_preoptConfig->setText(QApplication::translate("DefaultEditTab", "Configure...", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
